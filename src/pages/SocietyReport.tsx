...
export default function SocietyReport() {
  ...
  const metrics = useMemo(() => {
    ...
    // profit_share_seller = % do lucro de quem fez a venda
    // profit_share_partner = % do lucro do outro sócio
    const sellerProfitPct = selectedGroup.profit_share_seller / 100;
    const partnerProfitPct = selectedGroup.profit_share_partner / 100;
    ...
    const totalProfitAll = profitShareSplits.reduce((sum, s) => sum + s.amount, 0);
