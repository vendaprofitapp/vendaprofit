...
const navGroups: NavGroup[] = [
  ...
  },
  {
    label: "HUB DE VENDAS",
    items: [
      { icon: Building2, label: "HUB Fornecedor", path: "/hub-fornecedor" },
      { icon: ShoppingBasket, label: "HUB Vendedor", path: "/hub-vendedor" },
    ],
  },
  {
    label: "Marketing",
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Building2, label: "HUB Fornecedor", path: "/reports/hub-fornecedor" },
      { icon: ShoppingBasket, label: "HUB Vendedor", path: "/reports/hub-vendedor" },
